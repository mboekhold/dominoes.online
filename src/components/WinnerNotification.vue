                ...
                <div
                    ...
                    <div class="px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                        <div class="flex items-center">
                            <div
                                class="flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-full bg-yellow-100 sm:mx-0 sm:h-10 sm:w-10">
                            ...
                            <div class="ml-2 text-center sm:ml-4 sm:mt-0 sm:text-left">
                                <div class="flex items-center">
